...
import Indonesia from 'vue-tailwind/dist/l10n/id'

const settings = {
  't-input': {
    component: TInput,
    props: {
      fixedClasses: 'peer placeholder-transparent block w-full px-2 py-1 transition duration-100 ease-in-out border-t-0 border-l-0 border-r-0 border-b-0 text-base focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed',
      classes: 'text-black placeholder-gray-400 bg-white border-gray-300 focus:ring-0 focus:border-black placeholder-shown:border-gray-300',
      variants: {
        danger: 'placeholder-shown:border-red-300 bg-red-50 text-red-900',
        success: 'placeholder-shown:border-green-300 bg-green-50 text-green-900'
      }
    }
  },
  't-textarea': {
    component: TTextarea,
    props: {
      fixedClasses: 'block w-full px-2 py-1 transition duration-100 ease-in-out border-t-0 border-l-0 border-r-0 border-b text-base focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed',
      classes: 'text-black placeholder-gray-400 bg-white border-gray-300 focus:ring-0 focus:border-black',
      variants: {
  ...
  't-select': {
    component: TSelect,
    props: {
      fixedClasses: 'block w-full pl-2 pr-10 py-1 transition duration-100 ease-in-out border-t-0 border-l-0 border-r-0 border-b focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed',
      classes: 'text-black placeholder-gray-400 bg-white border-gray-300 focus:ring-0 focus:border-black',
      variants: {
        danger: 'border-red-300 bg-red-50 placeholder-red-200 text-red-900',
        success: 'border-green-300 bg-green-50 placeholder-gray-400 text-green-900'
  ...
  't-checkbox': {
    component: TCheckbox,
    props: {
      fixedClasses: 'transition duration-100 ease-in-out rounded shadow-sm focus:border-black focus:ring-2 focus:ring-black focus:outline-none focus:ring-opacity-50 focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed',
      classes: 'text-black border-gray-300 ',
      variants: {
        error: 'text-red-500 border-red-300',
        success: 'text-green-500 border-green-300'
      }
  ...
  't-datepicker': {
    ...
    props: {
      fixedClasses: {
        ...
        view: 'w-64',
        calendarDaysWrapper: 'grid grid-cols-7 w-full',
        calendarHeaderWrapper: 'grid grid-cols-7 w-full',
        monthWrapper: 'grid grid-cols-4',
        yearWrapper: 'grid grid-cols-4',
        input: ' w-full px-3 py-2 transition duration-100 ease-in-out border-t-0 border-l-0 border-r-0 border-b focus:border-black focus:ring-0 focus:outline-none focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed',
  ...
  't-dropdown': {
    ...
    props: {
      fixedClasses: {
        button: 'flex items-center text-black text-sm md:text-base block px-4 py-3 transition duration-100 ease-in-out border focus:border-blue-500 focus:ring-2 focus:ring-black focus:outline-none focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed',
        wrapper: 'inline-flex flex-col',
        dropdownWrapper: 'relative z-30',
        dropdown: 'origin-top-left absolute w-full',
        enterClass: 'opacity-0 scale-95',
        enterActiveClass: 'transition transform ease-out duration-100',
        enterToClass: 'opacity-100 scale-100',
        leaveClass: 'opacity-100 scale-100',
      ...
      classes: {
        button: '',
        dropdown: 'bg-white rounded shadow-lg min-w-28 w-full mt-2'
      },
      variants: {
        danger: {
